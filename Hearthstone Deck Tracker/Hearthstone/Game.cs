...
namespace Hearthstone_Deck_Tracker.Hearthstone
{
    public static class Game
    {
        ...
        public static PredictionUtility opponentSeer;
        ...
        static Game()
        {
            ...
            opponentSeer = new PredictionUtility();
        }
        ...
        public static void Reset()
        {
            ...
            // Reset the prediction utility and be ready for next game.
            opponentSeer.ResetPredictions();
        }
...
#pragma warning restore 4014
        ...
        public static void OpponentPlay(string id, int from, int turn)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                if (!card.IsStolen && card.Id != "GAME_005")
                {
                    if (string.IsNullOrEmpty(opponentSeer.PlayingClass))
                    {
                        opponentSeer.PlayingClass = PlayingAgainst;
                    }
                    opponentSeer.GuessDeck(card);
                }
        ...
        {
            Card card = GetActualCards().FirstOrDefault(c => c.Name.Equals(name, StringComparison.InvariantCultureIgnoreCase));
            if (card != null)
            {
